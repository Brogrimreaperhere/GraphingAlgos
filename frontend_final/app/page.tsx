...
import { ArrowRight, Cpu, Gauge, Network, Github, Users } from "lucide-react"

export default function Home() {
  return (
    <div className="flex flex-col min-h-[calc(100vh-4rem)]">
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-teal-light/30 to-background">
          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-4">
              <Link href="/dijkstra-mpi">
                <Button variant="gradient" size="lg" className="animated-button">
                  Explore Algorithms
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
              </Link>
              <Link href="https://github.com/Brogrimreaperhere/GraphingAlgos" target="_blank">
                <Button variant="outline" size="lg" className="animated-button">
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-12">
            <Card className="card-hover border-teal-light">
              <CardHeader className="bg-gradient-to-r from-teal-light to-teal-medium rounded-t-lg">
                <CardTitle className="flex items-center text-lg font-medium">
                  <Network className="h-5 w-5 mr-2 text-teal-dark" />
                  MPI
                </CardTitle>
              </CardHeader>
            ...
            <Card className="card-hover border-teal-light">
              <CardHeader className="bg-gradient-to-r from-teal-light to-teal-medium rounded-t-lg">
                <CardTitle className="flex items-center text-lg font-medium">
                  <Cpu className="h-5 w-5 mr-2 text-teal-dark" />
                  CUDA
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-4">
            ...
            <Card className="card-hover border-teal-light">
              <CardHeader className="bg-gradient-to-r from-teal-light to-teal-medium rounded-t-lg">
                <CardTitle className="flex items-center text-lg font-medium">
                  <Gauge className="h-5 w-5 mr-2 text-teal-dark" />
                  Performance Analysis
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-4">
                <CardDescription className="text-sm">
                  Our project provides comprehensive performance analysis of each algorithm implementation. We measure
                  execution times, calculate speedup factors, and analyze scaling behavior with different problem sizes
                  and processor counts. The results demonstrate how parallelism can dramatically reduce computation time
                  for graph algorithms, especially for large graphs with thousands of vertices.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-teal-light/20">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-12">
            <Link href="/dijkstra-mpi">
              <Card className="h-full transition-all hover:shadow-md card-hover border-teal-light">
                <CardHeader className="bg-gradient-to-r from-teal-light to-teal-medium rounded-t-lg">
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-3 mt-12">
            <Card className="card-hover border-teal-light">
              <CardHeader className="bg-gradient-to-r from-teal-light to-teal-medium rounded-t-lg">
                <CardTitle className="flex items-center text-lg font-medium">
                  <Users className="h-5 w-5 mr-2 text-teal-dark" />
                  Mohammad Noman
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-4 flex flex-col items-center">
                <div className="w-24 h-24 rounded-full bg-teal-medium flex items-center justify-center mb-4">
