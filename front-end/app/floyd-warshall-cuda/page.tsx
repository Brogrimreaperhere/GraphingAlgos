...
int main(int argc, char **argv) {
  ...
  return (
    <AlgorithmLayout
      ...
      description="A parallel implementation of the Floyd-Warshall all-pairs shortest path algorithm using CUDA for GPU-based parallelism on NVIDIA RTX 2080 Super with 16GB memory."
      implementation={
...
Memory usage:
  ...
  - Total GPU memory allocated: 4.00 MB
  - Peak GPU memory usage: 4.12 MB`}</code>
              </pre>
            </CardContent>
          </Card>
